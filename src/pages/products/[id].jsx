    ...
    <div>
      ...
      <div className="product-item">
        ...
        <div className="product-buy-now">
          <div className="btn btn-lg g-0 w-100 product-add-to-cart bg-primary rounded-2 text-center">
            ...
            <div className="add-to-cart-options ">
              <div className="row">
                <button className="col btn" onClick={addItemQuantityHandler}>
                  +
                </button>
                <span className="col d-flex align-items-center justify-content-center">
                  {productNumber}
                </span>
                <button className="col btn" onClick={minusItemQuantityHandler}>
                  -
                </button>
                <FontAwesomeIcon
        ...
        <div className="product-details">
          ...
          <div className="product-stock gray-color">In Stock: {data.stock}</div>
          <div className="product-brand gray-color">Brand: {data.brand}</div>
